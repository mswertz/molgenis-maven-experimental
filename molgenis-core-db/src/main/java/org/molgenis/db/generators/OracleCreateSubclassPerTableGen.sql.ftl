...
ALTER TABLE ${SqlName(entity)} ADD CONSTRAINT ${SqlName(entity)}_parent FOREIGN KEY (${SqlName(pkey(entity))}) REFERENCES ${SqlName(entity.getExtends())} (${SqlName(pkey(entity))});
</#if></#list>
