 ...
 * <p>
 * {@link org.molgenis.db.Database} is the "layer supertype" that
 * provides easy methods to search and store data. Searches can be filtered
 * using a {@link org.molgenis.db.QueryRule}. For advanced filtering
 * complex combinations of {@link org.molgenis.db.QueryRule} can be
 * more easily created using {@link org.molgenis.db.common.QueryImp}.
