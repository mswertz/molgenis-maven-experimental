...
public abstract class AbstractEntity implements Entity, Serializable
{
	...
	{
		if (this.get(FieldModel.TYPE_FIELD) != null) return this.get(FieldModel.TYPE_FIELD).toString();
		return null;
	}
	...
	{
		if (this.get(FieldModel.TYPE_FIELD + "_Label") != null) return this.get(FieldModel.TYPE_FIELD + "_Label").toString();
		return null;
	}
	...
	{
		if (this.get(FieldModel.TYPE_FIELD + "_options") != null) return (List<ValueLabel>) this.get(FieldModel.TYPE_FIELD
				+ "_options");
		return null;
	}
	...
	public void set__Type(String type)
	{
		...
		try
		{
			this.set(FieldModel.TYPE_FIELD, type);
		}
		catch (Exception e)
		{
			e.printStackTrace();
