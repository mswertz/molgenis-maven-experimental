package org.molgenis.db.paging;
...
import org.molgenis.db.common.DatabaseException;
...
public interface DatabasePager<E extends Entity> extends Serializable
{
	...
	/**
	 * Retrieve current order-by operator, either {@link org.molgenis.db.QueryRule.Operator#SORTASC} or {@link org.molgenis.db.QueryRule.Operator#SORTDESC}
	 * 
	 * @return Operator
	 */
	...
	/**
	 * Set the order-by operator, , either {@link org.molgenis.db.QueryRule.Operator#SORTASC} or {@link org.molgenis.db.QueryRule.Operator#SORTDESC}. If changed, the offset will be re-set to
