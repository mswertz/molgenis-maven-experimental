...
/* File:        test/model/TextEntity.java
...
/**
 * TextEntity: No description provided.
 * @version November 1, 2012 
 * @author MOLGENIS generator
 */
@javax.persistence.Entity
//@org.hibernate.search.annotations.Indexed
@javax.persistence.Table(name = "TextEntity"
)


@javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.FIELD)
//@EntityListeners({test.fields.db.TextEntityEntityListener.class})
public class TextEntity extends org.molgenis.db.common.AbstractEntity 
{
	...
	//static methods
	/**
	 * Shorthand for db.query(TextEntity.class).
	 */
	public static org.molgenis.db.Query<? extends TextEntity> query(org.molgenis.db.Database db)
	{
		return db.query(TextEntity.class);
	}
	
	/**
	 * Shorthand for db.find(TextEntity.class, org.molgenis.db.QueryRule ... rules).
	 */
	public static java.util.List<? extends TextEntity> find(org.molgenis.db.Database db, org.molgenis.db.QueryRule ... rules) throws org.molgenis.db.common.DatabaseException
	{
		return db.find(TextEntity.class, rules);
	}	
	
	/**
	 * TextEntity
	 */
	public static TextEntity findById(org.molgenis.db.Database db, Integer id) throws org.molgenis.db.common.DatabaseException
	{
		org.molgenis.db.Query<TextEntity> q = db.query(TextEntity.class);
		q.eq(TextEntity.ID, id);
		java.util.List<TextEntity> result = q.find();
	...
	//No description provided[type=text]
//	@javax.persistence.Lob()
	@javax.persistence.Column(name="normalText", length=16777216, nullable=false)
	...
	//No description provided[type=text]
//	@javax.persistence.Lob()
	@javax.persistence.Column(name="readonlyText", length=16777216, nullable=false)
	...
	//No description provided[type=text]
//	@javax.persistence.Lob()
	@javax.persistence.Column(name="nillableText", length=16777216)
	...
	//No description provided[type=text]
//	@javax.persistence.Lob()
	@javax.persistence.Column(name="defaultText", length=16777216, nullable=false)
	...
	public TextEntity()
	{
		...
		__type_options.add(new org.molgenis.db.common.ValueLabel("[TextEntity]","[TextEntity]"));
	}
	...
	public void set( org.molgenis.db.Tuple tuple, boolean strict )  throws Exception
	{
		if(tuple != null)
		{
			...
			if( tuple.getString("TextEntity___type") != null) this.set__Type(tuple.getString("TextEntity___type"));
			//set Id
			if( strict || tuple.getInt("id") != null) this.setId(tuple.getInt("id"));
			if( tuple.getInt("TextEntity_id") != null) this.setId(tuple.getInt("TextEntity_id"));
			//set NormalText
			if( strict || tuple.getString("normalText") != null) this.setNormalText(tuple.getString("normalText"));
			if( tuple.getString("TextEntity_normalText") != null) this.setNormalText(tuple.getString("TextEntity_normalText"));
			//set ReadonlyText
			if( strict || tuple.getString("readonlyText") != null) this.setReadonlyText(tuple.getString("readonlyText"));
			if( tuple.getString("TextEntity_readonlyText") != null) this.setReadonlyText(tuple.getString("TextEntity_readonlyText"));
			//set NillableText
			if( strict || tuple.getString("nillableText") != null) this.setNillableText(tuple.getString("nillableText"));
			if( tuple.getString("TextEntity_nillableText") != null) this.setNillableText(tuple.getString("TextEntity_nillableText"));
			//set DefaultText
			if( strict || tuple.getString("defaultText") != null) this.setDefaultText(tuple.getString("defaultText"));
			if( tuple.getString("TextEntity_defaultText") != null) this.setDefaultText(tuple.getString("TextEntity_defaultText"));
		}
	...
	/**
	 * Get the names of all public properties of TextEntity.
	 */
	...
	@Override
	public TextEntity create(org.molgenis.db.Tuple tuple) throws Exception
	{
