...
public class PublicationSecurityDecorator<E extends org.molgenis.core.Publication> extends MapperDecorator<E>
{
	public PublicationSecurityDecorator(Mapper<E> generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		{
			if (!this.getDatabase().getLogin().canWrite(org.molgenis.core.Publication.class))
				throw new DatabaseException("No write permission on org.molgenis.core.Publication");
	...
	public int count(QueryRule... rules) throws DatabaseException
	{
		if (this.getDatabase().getLogin() != null && !(this.getDatabase().getLogin() instanceof SimpleLogin))
		{
			if (!this.getDatabase().getLogin().canRead(org.molgenis.core.Publication.class))
				return 0;
