...
public class UseCaseSecurityDecorator<E extends org.molgenis.core.UseCase> extends MapperDecorator<E>
{
	public UseCaseSecurityDecorator(Mapper<E> generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		{
			if (!this.getDatabase().getLogin().canWrite(org.molgenis.core.UseCase.class))
				throw new DatabaseException("No write permission on org.molgenis.core.UseCase");
	...
	public int count(QueryRule... rules) throws DatabaseException
	{
		if (this.getDatabase().getLogin() != null && !(this.getDatabase().getLogin() instanceof SimpleLogin))
		{
			if (!this.getDatabase().getLogin().canRead(org.molgenis.core.UseCase.class))
				return 0;
