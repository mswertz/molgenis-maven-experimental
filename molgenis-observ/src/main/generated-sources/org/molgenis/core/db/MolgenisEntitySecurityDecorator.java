...
public class MolgenisEntitySecurityDecorator<E extends org.molgenis.core.MolgenisEntity> extends MapperDecorator<E>
{
	public MolgenisEntitySecurityDecorator(Mapper<E> generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		{
			if (!this.getDatabase().getLogin().canWrite(org.molgenis.core.MolgenisEntity.class))
				throw new DatabaseException("No write permission on org.molgenis.core.MolgenisEntity");
	...
	public int count(QueryRule... rules) throws DatabaseException
	{
		if (this.getDatabase().getLogin() != null && !(this.getDatabase().getLogin() instanceof SimpleLogin))
		{
			if (!this.getDatabase().getLogin().canRead(org.molgenis.core.MolgenisEntity.class))
				return 0;
