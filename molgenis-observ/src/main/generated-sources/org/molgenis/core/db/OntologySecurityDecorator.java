...
public class OntologySecurityDecorator<E extends org.molgenis.core.Ontology> extends MapperDecorator<E>
{
	public OntologySecurityDecorator(Mapper<E> generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		{
			if (!this.getDatabase().getLogin().canWrite(org.molgenis.core.Ontology.class))
				throw new DatabaseException("No write permission on org.molgenis.core.Ontology");
	...
	public int count(QueryRule... rules) throws DatabaseException
	{
		if (this.getDatabase().getLogin() != null && !(this.getDatabase().getLogin() instanceof SimpleLogin))
		{
			if (!this.getDatabase().getLogin().canRead(org.molgenis.core.Ontology.class))
				return 0;
