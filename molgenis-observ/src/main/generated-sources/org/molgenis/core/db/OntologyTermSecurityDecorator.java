...
public class OntologyTermSecurityDecorator<E extends org.molgenis.core.OntologyTerm> extends MapperDecorator<E>
{
	public OntologyTermSecurityDecorator(Mapper<E> generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		{
			if (!this.getDatabase().getLogin().canWrite(org.molgenis.core.OntologyTerm.class))
				throw new DatabaseException("No write permission on org.molgenis.core.OntologyTerm");
	...
	public int count(QueryRule... rules) throws DatabaseException
	{
		if (this.getDatabase().getLogin() != null && !(this.getDatabase().getLogin() instanceof SimpleLogin))
		{
			if (!this.getDatabase().getLogin().canRead(org.molgenis.core.OntologyTerm.class))
				return 0;
