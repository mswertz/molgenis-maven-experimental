...
public class RuntimePropertySecurityDecorator<E extends org.molgenis.core.RuntimeProperty> extends MapperDecorator<E>
{
	public RuntimePropertySecurityDecorator(Mapper<E> generatedMapper)
	{
	...
	public int add(List<E> entities) throws DatabaseException
	{
		...
		{
			if (!this.getDatabase().getLogin().canWrite(org.molgenis.core.RuntimeProperty.class))
				throw new DatabaseException("No write permission on org.molgenis.core.RuntimeProperty");
	...
	public int count(QueryRule... rules) throws DatabaseException
	{
		if (this.getDatabase().getLogin() != null && !(this.getDatabase().getLogin() instanceof SimpleLogin))
		{
			if (!this.getDatabase().getLogin().canRead(org.molgenis.core.RuntimeProperty.class))
				return 0;
