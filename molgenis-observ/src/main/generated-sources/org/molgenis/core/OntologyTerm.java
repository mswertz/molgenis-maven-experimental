...
/* File:        observ/model/OntologyTerm.java
...
//	@org.hibernate.search.annotations.Field(index=org.hibernate.search.annotations.Index.TOKENIZED, store=org.hibernate.search.annotations.Store.NO)
	...
	public OntologyTerm()
	{
		...
		__Type_options.add(new org.molgenis.util.ValueLabel("AlternateId","AlternateId"));
	}
...
//14
    ...
    private java.util.Collection<org.molgenis.pheno.Measurement> unitMeasurementCollection = new java.util.ArrayList<org.molgenis.pheno.Measurement>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.pheno.Measurement> getUnitMeasurementCollection()
	{
            return unitMeasurementCollection;
	}

    public void setUnitMeasurementCollection(java.util.Collection<org.molgenis.pheno.Measurement> collection)
    {
        for (org.molgenis.pheno.Measurement measurement : collection) {
            measurement.setUnit(this);
        }
        unitMeasurementCollection = collection;
    }	
//14
    ...
    private java.util.Collection<org.molgenis.pheno.Panel> panelTypePanelCollection = new java.util.ArrayList<org.molgenis.pheno.Panel>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.pheno.Panel> getPanelTypePanelCollection()
	{
            return panelTypePanelCollection;
	}

    public void setPanelTypePanelCollection(java.util.Collection<org.molgenis.pheno.Panel> collection)
    {
...
//14
	@javax.persistence.OneToMany(fetch=javax.persistence.FetchType.LAZY, mappedBy="ontologyReference"/*, cascade={javax.persistence.CascadeType.MERGE, javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.REFRESH}*/)
    private java.util.Collection<org.molgenis.pheno.ObservedValue> ontologyReferenceObservedValueCollection = new java.util.ArrayList<org.molgenis.pheno.ObservedValue>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.pheno.ObservedValue> getOntologyReferenceObservedValueCollection()
	{
            return ontologyReferenceObservedValueCollection;
	}

    public void setOntologyReferenceObservedValueCollection(java.util.Collection<org.molgenis.pheno.ObservedValue> collection)
    {
        for (org.molgenis.pheno.ObservedValue observedValue : collection) {
            observedValue.setOntologyReference(this);
        }
        ontologyReferenceObservedValueCollection = collection;
    }	
//14
...
//14
    ...
    private java.util.Collection<org.molgenis.protocol.Protocol> protocolTypeProtocolCollection = new java.util.ArrayList<org.molgenis.protocol.Protocol>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.protocol.Protocol> getProtocolTypeProtocolCollection()
	{
            return protocolTypeProtocolCollection;
	}

    public void setProtocolTypeProtocolCollection(java.util.Collection<org.molgenis.protocol.Protocol> collection)
    {
...
//14
	...
	//14
    @javax.persistence.ManyToMany(fetch=javax.persistence.FetchType.LAZY, mappedBy="ontologyReference"/*, cascade={javax.persistence.CascadeType.MERGE, javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.REFRESH}*/)
    private java.util.Collection<org.molgenis.pheno.ObservationElement> ontologyReferenceObservationElementCollection = new java.util.ArrayList<org.molgenis.pheno.ObservationElement>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.pheno.ObservationElement> getOntologyReferenceObservationElementCollection()
	{
        return ontologyReferenceObservationElementCollection;
	}

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.pheno.ObservationElement> getOntologyReferenceObservationElementCollection(org.molgenis.framework.db.Database db)
	{
        return getOntologyReferenceObservationElementCollection();
	}

    public void setOntologyReferenceObservationElementCollection(java.util.Collection<org.molgenis.pheno.ObservationElement> collection)
    {
    	ontologyReferenceObservationElementCollection.addAll(collection);
    }	
	//14
    @javax.persistence.ManyToMany(fetch=javax.persistence.FetchType.LAZY, mappedBy="ontologyReference"/*, cascade={javax.persistence.CascadeType.MERGE, javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.REFRESH}*/)
    private java.util.Collection<org.molgenis.protocol.Protocol> ontologyReferenceProtocolCollection = new java.util.ArrayList<org.molgenis.protocol.Protocol>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.protocol.Protocol> getOntologyReferenceProtocolCollection()
	{
        return ontologyReferenceProtocolCollection;
	}

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.protocol.Protocol> getOntologyReferenceProtocolCollection(org.molgenis.framework.db.Database db)
	{
        return getOntologyReferenceProtocolCollection();
	}

    public void setOntologyReferenceProtocolCollection(java.util.Collection<org.molgenis.protocol.Protocol> collection)
    {
    	ontologyReferenceProtocolCollection.addAll(collection);
    }	
	//14
    @javax.persistence.ManyToMany(fetch=javax.persistence.FetchType.LAZY, mappedBy="ontologyReference"/*, cascade={javax.persistence.CascadeType.MERGE, javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.REFRESH}*/)
    private java.util.Collection<org.molgenis.protocol.ProtocolApplication> ontologyReferenceProtocolApplicationCollection = new java.util.ArrayList<org.molgenis.protocol.ProtocolApplication>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.protocol.ProtocolApplication> getOntologyReferenceProtocolApplicationCollection()
	{
        return ontologyReferenceProtocolApplicationCollection;
	}

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.protocol.ProtocolApplication> getOntologyReferenceProtocolApplicationCollection(org.molgenis.framework.db.Database db)
	{
        return getOntologyReferenceProtocolApplicationCollection();
	}

    public void setOntologyReferenceProtocolApplicationCollection(java.util.Collection<org.molgenis.protocol.ProtocolApplication> collection)
    {
    	ontologyReferenceProtocolApplicationCollection.addAll(collection);
    }	
