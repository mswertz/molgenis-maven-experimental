...
//	@org.hibernate.search.annotations.Field(index=org.hibernate.search.annotations.Index.TOKENIZED, store=org.hibernate.search.annotations.Store.NO)
	...
	public MolgenisFile()
	{
		...
		__Type_options.add(new org.molgenis.util.ValueLabel("MolgenisFile","MolgenisFile"));
		__Type_options.add(new org.molgenis.util.ValueLabel("ProtocolDocument","ProtocolDocument"));
	}
	...
	public void set( org.molgenis.util.Tuple tuple, boolean strict )  throws Exception
	{
		...
		else if(tuple != null)
		{
			...
			if( tuple.getString("MolgenisFile___Type") != null) this.set__Type(tuple.getString("MolgenisFile___Type"));
			//set Extension
