...
/* File:        Observ/html/ObservableFeature.java
...
public class ObservableFeatureForm extends EntityForm<ObservableFeature>
{
	...
	{	
		...
		//Investigation: Field(entity=ObservationElement, name=Investigation, type=xref[Investigation.id], xref_label='name', auto=false, nillable=true, readonly=false, default=)
		{
			...
			//XrefInput input = new XrefInput("ObservableFeature_Investigation", getEntity().getInvestigation());
			...
			XrefInput input = new XrefInput("ObservableFeature_Investigation", org.molgenis.organization.Investigation.class, dummy);
		...
		{
			//TODO: when we have JPA this should become:
			//MrefInput input = new MrefInput("ObservableFeature_ontologyReference", getEntity().getOntologyReference());
			...
			MrefInput input = new MrefInput("ObservableFeature_ontologyReference", org.molgenis.core.OntologyTerm.class, dummyList);
		...
		{
			//TODO: when we have JPA this should become:
			//MrefInput input = new MrefInput("ObservableFeature_AlternateId", getEntity().getAlternateId());
			//create xref dummy list of references
			...
			MrefInput input = new MrefInput("ObservableFeature_AlternateId", org.molgenis.pheno.AlternateId.class, dummyList);
		...
		{
			StringInput input = new StringInput("ObservableFeature_label",getEntity().getLabel());
