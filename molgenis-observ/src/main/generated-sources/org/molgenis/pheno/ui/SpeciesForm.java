...
public class SpeciesForm extends EntityForm<Species>
{
	...
	{	
		...
		//Ontology: Field(entity=OntologyTerm, name=ontology, type=xref[Ontology.id], xref_label='name', auto=false, nillable=true, readonly=false, default=)
		{
			...
			//XrefInput input = new XrefInput("Species_ontology", getEntity().getOntology());
			...
			XrefInput input = new XrefInput("Species_ontology", org.molgenis.core.Ontology.class, dummy);
		...
		{
			StringInput input = new StringInput("Species_termPath",getEntity().getTermPath());
