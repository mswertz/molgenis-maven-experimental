...
public class UsedMolgenisOptions extends MolgenisOptions
{
	...
	public UsedMolgenisOptions(){
		...
		this.model_database = new ArrayList<String>(Arrays.asList(new String[]{"src/main/resources/pheno.xml" ,"src/main/resources/organization.xml" ,"src/main/resources/core.xml" ,"src/main/resources/protocol.xml" ,"src/main/resources/auth.xml"}));
		...
		this.model_userinterface = "src/main/resources/observ_ui.xml";
