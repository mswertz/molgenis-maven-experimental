...
public class ExcelExport
{
	...
	public void exportAll(File excelFile, Database db, boolean skipAutoId, QueryRule ... rules) throws Exception
	{
		...
		copyCsvToWorkbook("AlternateId", new File(directory+"/alternateid.txt"), workbook, headerFormat, cellFormat);		
		...
		copyCsvToWorkbook("Publication", new File(directory+"/publication.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("UseCase", new File(directory+"/usecase.txt"), workbook, headerFormat, cellFormat);		
		...
		copyCsvToWorkbook("ObservationElement", new File(directory+"/observationelement.txt"), workbook, headerFormat, cellFormat);		
		...
		copyCsvToWorkbook("Measurement", new File(directory+"/measurement.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("Individual", new File(directory+"/individual.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("Location", new File(directory+"/location.txt"), workbook, headerFormat, cellFormat);		
		...
		copyCsvToWorkbook("Workflow", new File(directory+"/workflow.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("ProtocolApplication", new File(directory+"/protocolapplication.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("ObservedValue", new File(directory+"/observedvalue.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("ProtocolDocument", new File(directory+"/protocoldocument.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("WorkflowElement", new File(directory+"/workflowelement.txt"), workbook, headerFormat, cellFormat);		
		copyCsvToWorkbook("WorkflowElementParameter", new File(directory+"/workflowelementparameter.txt"), workbook, headerFormat, cellFormat);		
