...
<#list entities as entity><#if entities?seq_contains(entity) && (!entity.system || rendersystem) && !entity.association>
               "${JavaName(entity)}" [
                        ...
                        label = "{<#if entity.abstract>Interface:</#if>${JavaName(entity)}<#if entity.hasImplements()>\n implements ${csv(entity.getImplements())}</#if><#if entity.hasExtends()>\n extends ${name(entity.getExtends())}</#if>|<#list entity.allFields as f><#if !f.system>${name(f)} : ${f.type}<#if f.type=="xref" || f.type="mref">-&gt;${name(f.xrefEntity)}</#if><#if !f.nillable>*</#if>\l</#if></#list>}"
                ]
...
<#list m.entities as entity><#if entities?seq_contains(entity) && (!entity.system || rendersystem) && !entity.association>
                "${JavaName(entity)}" [
                        ...
                        label = "{<#if entity.abstract>Interface:</#if>${JavaName(entity)}<#if entity.hasImplements()>\n implements ${csv(entity.getImplements())}</#if><#if entity.hasExtends()>\n extends ${entity.getExtends().getName()}</#if>|<#list entity.allFields as f><#if !f.system>${name(f)} : ${f.type}<#if f.type=="xref" || f.type="mref">-&gt;${name(f.xrefEntity)}</#if><#if !f.nillable>*</#if>\l</#if></#list>}"
                ]
</#if></#list>
/*        }  */
</#list>
...
<#list entities as entity>
	<#if entities?seq_contains(entity) && entity.hasExtends() && (!entity.extends.system || rendersystem)>  
        "${JavaName(entity)}" -> "${JavaName(entity.extends)}"
    </#if>
</#list>
