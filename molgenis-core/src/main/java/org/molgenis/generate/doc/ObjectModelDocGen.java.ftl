...
<h3><a href="${entity.name}">${entity.name}</a><#if entity.abstract> (interface).</#if></h3>
<p style="margin-top: 0px; margin-bottom: 0px;">
<#if entity.hasExtends()><span style="font-style:italic"> extends ${entity.getExtends().getName()}</span><br></#if>
