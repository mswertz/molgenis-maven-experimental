...
/* File:        Test/html/VarcharEntity.java
...
/**
 * A HtmlForm that is preloaded with all inputs for entity VarcharEntity
 * @see EntityForm
 */
public class VarcharEntityForm extends EntityForm<VarcharEntity>
{
	
	public VarcharEntityForm()
	{
		super();
	}
	
	public VarcharEntityForm(VarcharEntity entity)
	{
		super(entity);
	}
	...
	@Override
	public Class<VarcharEntity> getEntityClass()
	{
		return VarcharEntity.class;
	}
