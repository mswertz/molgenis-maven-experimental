...
/**
 * A HtmlForm that is preloaded with all inputs for entity BextendsA
 * @see EntityForm
 */
public class BextendsAForm extends EntityForm<BextendsA>
{
	
	public BextendsAForm()
	{
		super();
	}
	
	public BextendsAForm(BextendsA entity)
	{
		super(entity);
	}
	...
	@Override
	public Class<BextendsA> getEntityClass()
	{
		return BextendsA.class;
	}
