...
/* File:        Test/html/DextendsBimplementsA.java
...
import test.inheritance.DextendsBimplementsA;


/**
 * A HtmlForm that is preloaded with all inputs for entity DextendsBimplementsA
 * @see EntityForm
 */
public class DextendsBimplementsAForm extends EntityForm<DextendsBimplementsA>
{
	
	public DextendsBimplementsAForm()
	{
		super();
	}
	
	public DextendsBimplementsAForm(DextendsBimplementsA entity)
	{
		super(entity);
	}
	...
	@Override
	public Class<DextendsBimplementsA> getEntityClass()
	{
		return DextendsBimplementsA.class;
	}
